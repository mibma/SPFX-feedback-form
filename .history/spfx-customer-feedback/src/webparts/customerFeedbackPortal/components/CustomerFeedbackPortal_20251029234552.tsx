import * as React from 'react'; import { useState, useEffect } from 'react'; import styles from './CustomerFeedbackPortal.module.scss'; import { TextField, PrimaryButton, Rating, RatingSize, Dropdown, IDropdownOption } from '@fluentui/react'; import "@pnp/sp/webs"; import "@pnp/sp/lists"; import "@pnp/sp/items"; import "@pnp/sp/fields"; import "@pnp/sp/lists/web"; import { getSP } from "../pnpConfigFile"; import "@pnp/sp/site-users/web";
